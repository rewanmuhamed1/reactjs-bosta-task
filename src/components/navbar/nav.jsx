...
const pages = ["home", "Pricing", "CallSales"];
const pages2 = ["TrackShipment", "Login"];
...
function Nav() {
  ...
  return (
    <AppBar position="static" sx={{ boxShadow: 0, borderBottom: 1, borderColor: '#e0e0e0', backgroundColor: 'primary.contrastText' }}>
        ...
        <Toolbar disableGutters >
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' }, justifyContent: 'flex-end' }}>
            ...
            <Menu
              ...
              sx={{
                width: '100%',
                maxWidth: '100%', display: { xs: 'block', md: 'none' }
              }}
              PaperProps={{
                sx: {
                  width: '100%',
            ...
            >
              {pages.map((page) => (
                <MenuItem key={page} onClick={handleCloseNavMenu} sx={{ textAlign: 'center', display: 'block' }}>
              ...
              <Box sx={{ textAlign: 'center', display: 'block' }}>
                <select style={{ border: '0', color: '#e30613' }} onChange={(e) => changeLanguage(e.target.value)}>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' }, justifyContent: 'flex-end' }}>
            {pages.map((page) => (
              <Button
                ...
                sx={{ my: 2, color: 'text.primary', display: 'block', fontSize: 16, fontFamily: 'Cairo, sans-serif', ml: 5 }}
              >
                {t(`${page}`)}
              </Button>
            ))}
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' }, justifyContent: 'flex-end' }}>
            {pages2.map((page) => (
              <Button
                key={page}
                onMouseEnter={page === "TrackShipment" ? handleMouseEnter : undefined}
                onMouseLeave={page === "TrackShipment" ? handleMouseLeave : undefined}
                onClick={handleCloseNavMenu}
                sx={{ my: 2, color: 'text.primary', display: 'block', fontSize: 16, fontFamily: 'Cairo, sans-serif', ml: 5 }}
              >
                {t(`${page}`)}
            ...
            {isHovered && (
             <div style={{
              ...
              zIndex: 1,
              top: i18n.language === 'ar' ? '100%' : '100%', 
              left: i18n.language === 'ar' ? '30%' : '80%', 
              transform: i18n.language === 'ar' ? 'translateX(-50%)' : 'translateX(-50%)', 
            }}>
        <SearchInput title={t('TrackShipment')} placeholder={t('TrackingNumber')}/>
        </div>
      )}
          </Box>
